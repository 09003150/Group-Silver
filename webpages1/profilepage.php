            ...
            <div class="art-Sheet-body">
                ...
                <div class="art-nav">
                	...
                	<ul class="art-menu">
                		...
                		<li> <a href="profile.php"><span class="l"></span><span class="r"></span><span class="t">My Profile</span></a>
                		<li>
...
<!--THIS IS WHERE YOU POST CONTENT-->										
	...
	<h4> Welcome User</h4>
	<br></br>	
	<a href = "currenttasks.php"> Click here to view your current tasks. </a></br>

	<a href = "previoustasks.php"> Click here to view your current tasks that you have completed. </a></br>

    <a href = "unclaimedtasks.php"> Click here to view unclaimed tasks. </a></br>	
