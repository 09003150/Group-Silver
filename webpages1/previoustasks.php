...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" xml:lang="en" class="gecko  win" lang="en-US"><head>
            ...
            <div class="art-Sheet-body">
                <div class="art-Header">
                    ...
                    <div class="art-Logo">
                        ...
                        <div id="slogan-text" class="art-Logo-text">Website for academic papers</div>
                    </div>
                </div>
                <div class="art-nav">
                	<div class="l"></div>
...
<table border="2">
  ...
  <?php
	...
	$stmt = $dbh->query("SELECT TaskID, UserID, TaskTitle, TaskDesc, 
                         ClaimDeadline, SubmissionDeadline FROM taskstable");
	...
	while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
		...
		printf("
				<tr>
					...
					<td> %s </td>
					<td> %s </td>
					<td><a href='#' title='Details'>Details</a></td>
				</tr>", $claimID, $taskID, $title, $userID, $description, $claimDeadline, $submissionDeadline);
	}
	...
	while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
		...
		printf("
				<tr>
					...
					<td> %s </td>
					<td><a href='#' title='Details'>Details</a></td>
				</tr>", $taskID, $title, $userID, $description, $claimDeadline, $submissionDeadline);
	}
